...
: ${AMENT_CURRENT_PREFIX:="/robots_HW/TASK_4/install/task_4"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/task_4/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/task_4/environment/path.sh"
