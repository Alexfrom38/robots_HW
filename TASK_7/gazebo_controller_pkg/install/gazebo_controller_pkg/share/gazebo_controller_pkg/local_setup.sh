...
: ${AMENT_CURRENT_PREFIX:="/robots_HW/TASK_7/gazebo_controller_pkg/install/gazebo_controller_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gazebo_controller_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gazebo_controller_pkg/environment/path.sh"
